...
void PressureSystem::validateChoice(int user_choice, const std::vector<int> &acceptable_Pressure_options) {
...
void PressureSystem::startSystem() {
    ...
    while (true) {
        ...
        if (user_choice == 3) {
            ...
            std::cout << "Please insert the value of the pressure :" << std::endl;
            std::cout << "Pressure = ";
            pressure = getPressure();
            bar_To(pressure);
        }
